...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        //Enable or disable operation buttons based on the state of the bottom number
        view.updateRootAllowed(model.bottom().compareTo(INT_LIMIT) <=0 && model.bottom().compareTo(TWO)>=0);
